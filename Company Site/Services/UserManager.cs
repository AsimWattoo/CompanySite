...
namespace Company_Site.Services
{
    public class UserManager
    {
        ...
        {
            new User(){ FirstName = "Muhammad", LastName="Asim", Designation="CEO", Department="Finance",
            ...
            new User(){ FirstName = "Muhammad", LastName="Asim", Designation="CFO", Department="Finance",
